...
async function loadUsers() {
  try {
      ...
      row.innerHTML = `
                ...
                <td>
                    <div class="action-buttons">
                        <button class="btn btn-primary btn-small edit-btn" onclick='showEditUserForm(${JSON.stringify(
                          user
                        )})'>
                        ...
                        <button class="btn btn-danger btn-small delete-btn" onclick="deleteUser('${
                          user._id
                        }')">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    // Dispatch event with real stats
    window.dispatchEvent(new CustomEvent("usersLoaded", { detail: stats }));
  } catch (error) {
