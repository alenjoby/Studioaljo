document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('showAddUserForm').addEventListener('click', showAddUserForm);
    document.getElementById('cancelAddUser').addEventListener('click', hideAddUserForm);
    document.getElementById('cancelEditUser').addEventListener('click', hideEditUserForm);
});
            ...
            row.innerHTML = `
                ...
                <td>
                    <div class="action-buttons">
                        <button class="edit-btn" onclick='showEditUserForm(${JSON.stringify(user)})'>Edit</button>
